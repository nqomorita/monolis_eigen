...
contains
  ...
  subroutine C3D8_node_point(i, r)
    implicit none
    integer(kint) :: i
    real(kdouble) :: gsp(3,8), r(3)

    gsp(1,1) = -1.0d0; gsp(2,1) = -1.0d0; gsp(3,1) = -1.0d0
    gsp(1,2) =  1.0d0; gsp(2,2) = -1.0d0; gsp(3,2) = -1.0d0
    gsp(1,3) =  1.0d0; gsp(2,3) =  1.0d0; gsp(3,3) = -1.0d0
    gsp(1,4) = -1.0d0; gsp(2,4) =  1.0d0; gsp(3,4) = -1.0d0
    gsp(1,5) = -1.0d0; gsp(2,5) = -1.0d0; gsp(3,5) =  1.0d0
    gsp(1,6) =  1.0d0; gsp(2,6) = -1.0d0; gsp(3,6) =  1.0d0
    gsp(1,7) =  1.0d0; gsp(2,7) =  1.0d0; gsp(3,7) =  1.0d0
    gsp(1,8) = -1.0d0; gsp(2,8) =  1.0d0; gsp(3,8) =  1.0d0

    r(1) = gsp(1,i)
    r(2) = gsp(2,i)
    r(3) = gsp(3,i)
  end subroutine C3D8_node_point
...
end module mod_soild_c3d8_shape
